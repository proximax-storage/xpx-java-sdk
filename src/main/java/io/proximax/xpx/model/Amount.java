...
public class Amount {
   ...
   * Num micro proximax.
   *
   * @param numMicroNem the num micro proximax
   * @return the amount
   */
  ...
  /**
   * Sets the num micro proximax.
   *
   * @param numMicroNem the new num micro proximax
   */
  ...
  /**
   * Sets the num proximax.
   *
   * @param numNem the new num proximax
   */
