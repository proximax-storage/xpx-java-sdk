...
public class SecuredWithPasswordPrivacyStrategy extends AbstractPrivacyStrategy {

    private String senderOrReceiverPrivateKey;
    private String receiverOrSenderPublicKey;

    public SecuredWithPasswordPrivacyStrategy(String senderOrReceiverPrivateKey, String receiverOrSenderPublicKey) {
