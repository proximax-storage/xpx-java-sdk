...
public class ApiClient {
	...
	public ApiClient() {
		...
		httpClient.setReadTimeout(600000, TimeUnit.MILLISECONDS);
		httpClient.setWriteTimeout(600000, TimeUnit.MILLISECONDS);
		verifyingSsl = true;
	 ...
	 *
	 * @param basePath
	 *            Base path of the URL (e.g http://localhost:8881
