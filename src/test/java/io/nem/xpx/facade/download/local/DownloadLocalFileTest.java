...
//					"19194b6f58ab41347b41279fcb7e8d3e14829520b2a81aad2a0fb4628aa3cc6e", this.xPvkey, this.xPubkey);
//
//			// validate the name.
//			Assert.assertEquals("Assertion failed: Decryted data is not equal to expected", "1522986734615",
//					message.getDataMessage().getName());
//			LOGGER.info(message.getDataMessage().getName());
//			// validate the content.
//			Assert.assertEquals("Assertion failed: Decryted data is not equal to expected", "18mEpQDqhuCDwQnqCqBFzsfKk4mzYThrjk",
...
//
//			DownloadData message = download.downloadFileOrData(
//					"59049f8a9a47c0625f971b89199ab889e582912f58cadd284de1a3fececf21a5", this.xPvkey, this.xPubkey);
//
//			FileUtils.writeByteArrayToFile(new File("src//test//resources//downloadPlainFileTest_"
//					+ message.getDataMessage().getName() + timeStamp + ".pdf"),
